...
## Adaptación realizada (Dashboard.py)

Se adaptó el archivo `Dashboard.py` para apoyar la organización de actividades de la materia:

- Se agregó un **Gestor de Tareas / Proyectos** usando Programación Orientada a Objetos (clases `Tarea` y `GestorTareas`).
- Se implementó persistencia en archivo **JSON**: las tareas se guardan en `tareas.json`.
- El Dashboard mantiene la opción de **navegar unidades**, **visualizar código** y **ejecutar scripts**.
